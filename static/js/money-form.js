async function successAfterSubmit() {
    ...
    htmlString = `\n<div class="alert alert-success" role="alert">\n
                    \nThank you for your donation! See your donation history <a href="/history/money" class="alert-link">here</a>\n
                    </div>`
...
document.getElementById("button-submit").onclick = submitMoney